...
class SubscriptionForm extends HTMLElement {
  constructor () {
    ...
    this.endpoint = '/api/admin/subscription'
      ...
      <div class="form">
        ...
        <div class="sectionMain">
          ...
          <form>
            ...
            <div class="tab-content active" data-tab="general">
              <div class="fieldGroup">
                <label for="name">Título Formulario</label>
                <input type="text" id="formTitle" name="formTitle">
              </div>
              <div class="fieldGroup">
                <label for="name">Descripción Formulario</label>
                <input type="text" id="formDescription" name="formDescription">
              </div>
              <div class="fieldGroup">
                <label for="name">Texto input</label>
                <input type="text" id="inputPlaceholder" name="inputPlaceholder">
              </div>
              <div class="fieldGroup">
              ...
              <div class="fieldGroup">
                <label for="name">Enlace botón</label>
