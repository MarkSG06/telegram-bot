      ...
      if (event.target.closest('.save-button')) {
        ...
        for (const [key, value] of new FormData(form).entries()) {
          ...
          if (input?.type === 'checkbox') {
            formDataJson[key] = input.checked
          } else {
            formDataJson[key] = value !== '' ? value : null
          }
        }

        // Asegurar que los checkboxes estén presentes incluso si no fueron cambiados
        formDataJson.selected = this.shadow.querySelector('[name="selected"]').checked
        formDataJson.default = this.shadow.querySelector('[name="default"]').checked
