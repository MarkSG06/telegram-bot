...
const EventOccurrences = sequelizeDb.EventOccurrences
const Op = sequelizeDb.Sequelize.Op

exports.create = async (req, res, next) => {
  try {
    const data = await EventOccurrences.create(req.body)
...
exports.findAll = async (req, res, next) => {
  try {
    ...
    const result = await EventOccurrences.findAndCountAll({
      where: condition,
...
exports.findOne = async (req, res, next) => {
  try {
    ...
    const data = await EventOccurrences.findByPk(id)
...
exports.update = async (req, res, next) => {
  try {
    const id = req.params.id
    const [numberRowsAffected] = await EventOccurrences.update(req.body, { where: { id } })
...
exports.delete = async (req, res, next) => {
  try {
    const id = req.params.id
    const numberRowsAffected = await EventOccurrences.destroy({ where: { id } })
